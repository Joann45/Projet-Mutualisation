...
@app.route('/home/creation-offre', defaults={'id_offre': None}, methods=['GET','POST'])    
@app.route('/home/creation-offre/<int:id_offre>', methods=['GET','POST'])
@login_required
...
# @app.route('/home/modification-offre/<int:id_offre>', methods=['GET','POST'])
# @login_required
# def modifier_offre(id_offre):
#     """Renvoie la page de création d'une offre
